              ...
              <div class="register_section">
                <div class="register_step_bg" ng-if="tab==1">
                  ...
                  <p>
                    ...
                    <span><input disabled type="text" name="user_name" ng-model="company.user_name" required></span>
                  ...
                  <p>
                    <span>Email</span>
                    <span><input disabled type="email" name="user_email" ng-model="company.user_email" required></span>
                  ...
                  <p>
                    <span><img width="150" ng-src="{{'<?= $this->Url->build('/upload/logo/');?>'+company.logo}}"></span>
                  </p>
                  <p>
                    <span>Logo</span>
                    <span><input type="file"  id="company_logo"></span>
                  </p>
                  <p>
